...
type NumpyMultiDataset struct {
	...
	StartIndex           map[string]int32 `protobuf:"bytes,2,rep,name=start_index,json=startIndex,proto3" json:"start_index,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"zigzag32,2,opt,name=value,proto3"`
...
var fileDescriptor_a89eb64cdc1fc4a5 = []byte{
	...
	,
}
