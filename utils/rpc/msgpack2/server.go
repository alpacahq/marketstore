...
func (c *CodecRequest) ReadRequest(args interface{}) error {
	if c.err == nil && c.request.Params != nil {
		...
		// msgpack package doesn't provide RawMessage unlike json,
		// so encode it again and decode using the target type.  Ugh.
		encoded, _ := msgpack.Marshal(c.request.Params)
