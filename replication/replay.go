...
type Writer interface{
	WriteBufferToFile(fp stdio.WriterAt, buffer executor.OffsetIndexBuffer) error
	// for variable length record
	WriteBufferToFileIndirect(fp *os.File, buffer executor.OffsetIndexBuffer, varRecLen int32) (err error)
}
