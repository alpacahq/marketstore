...
type Item struct {
	...
	MaturityDate time.Time					`reorg:"line:3 pos:64-72 format:01/02/06"`
	ProDate time.Time						`reorg:"line:4 pos:64-72 format:01/02/06"`
	DealNumber string						`reorg:"line:1 pos:6-8"`
	Cusip string							`reorg:"line:2 pos:7-16"`
	TextNumber string						`reorg:"line:1 pos:16-23"`
	IssuerDesc string						`reorg:"line:2 pos:19-29"`
	NotificationType string					`reorg:"line:1 pos:53,55"`
	Status string							`reorg:"line:1 pos:54"`
	Options string							`reorg:"line:1 pos:56"`
	SecurityType string						`reorg:"line:1 pos:57"`
	VoluntaryMandatory string				`reorg:"line:4 pos:33"`
	PreviousTextNumber string				`reorg:"line:5 pos:62-69"`
	FreeText string
}
...
func main() {
	//buff, _ := ioutil.ReadFile("../../ICEFTP/reorg.20201007")
	//content := string(buff)
	content := record 
	var items = []Item{}
